                  ...
                  <div class="iq-card">
                       ...
                       @foreach ($orders as $index => $order)
                           <tr>
                               ...
                               <td>
                                  <a href="{{route ('orderdetail.show', $order->order_id)}}" type="button" class="btn mb-1 btn-info rounded-pill "><i class="ri-draft-line"></i>Lihat Detail</a>
                              </td>
                           </tr>
                           @endforeach
                       </tbody>
